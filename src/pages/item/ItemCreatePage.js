      ...
      try {
        window.PeterTecnetTelemetry?.track?.("plat_first_catalog_item_created", {
          ...
          metadata: {
            ...
            onboarding: Boolean(location.state?.onboarding),
  ...
  return <>
    ...
    <Container className="main-container" fluid>
      <Row className="mb-3 align-items-center">
        ...
        <Col className="text-end"><Button variant="secondary" onClick={() => navigate(`/item/list/${establishment.slug}`)}>Voltar</Button></Col>
      </Row>
      <section className="plat-item-preview-card">
        ...
        <div className="plat-item-preview-copy">
          ...
          <p>{description || "A descrição do item aparecerá aqui."}</p>
